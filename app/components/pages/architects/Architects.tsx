      ...
      <div className="flex px-8 gap-x-8 pb-12 bg-white || dark:bg-black">
        <div className="relative justify-start hidden w-1/4 h-full px-4 mx-auto text-center md:block">
          <div className="fixed w-1/4 mt-4 text-left">
            <h1 className="text-sm text-black uppercase font-bold || dark:text-white">
              Find Architects
            </h1>
            <p className="w-4/5 text-xs py-2 text-black font-light || dark:text-white">
              Search architects using either full name, phone number or
              architect&apos;s DMN.
            </p>
            <input
              type="text"
            ...
            <div className="pt-2">
              <Button
                type="flat-gradient"
                text="SEARCH"
                icon={<BiSearchAlt size="25" className="pt-1" />}
              />
            </div>
            
            <div className="mt-12">
              <h1 className="text-sm text-black uppercase font-bold mb-2 || dark:text-white">
                News & Events
              </h1>
